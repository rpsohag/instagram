        ...
        <div className="row ">
            <div
                ...
                <div className="d-flex align-items-center  justify-content-sm-end justify-content-md-start m-2" role="button">
                    ...
                    <p className="d-none d-md-block fs-4 pt-3 ps-2">Search</p>
                </div>
                <div className="d-flex align-items-center  justify-content-sm-end justify-content-md-start m-2" role="button">
                ...
                <div className="d-flex align-items-center  justify-content-sm-end justify-content-md-start m-2" role="button">
                    ...
                    <p className="d-none d-md-block fs-4 pt-3 ps-2">Reels</p>
                </div>
                <div className="d-flex align-items-center  justify-content-sm-end justify-content-md-start m-2" role="button">
                ...
                <div className="d-flex align-items-center  justify-content-sm-end justify-content-md-start m-2" role="button">
                    ...
                    <p className="d-none d-md-block fs-4 pt-3 ps-2">Create</p>
                </div>
                <div className="d-flex align-items-center  justify-content-sm-end justify-content-md-start m-2" role="button">
                    <span><img className='rounded-circle sidebar__profile_photo' src="https://i.ibb.co/rx1k7h1/322733152-431477945761277-2102060376022704541-n.jpg" alt="" /></span>
                    <p className="d-none d-md-block fs-4 pt-3 ps-2">Profile</p>
                </div>
                <div className="d-flex align-items-center  justify-content-sm-end justify-content-md-start m-2" role="button">
                    <span><svg aria-label="Settings" className="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="4" y2="4"></line><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="12" y2="12"></line><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="20" y2="20"></line></svg></span>
                    <p className="d-none d-md-block fs-4 pt-3 ps-2">More</p>
                </div>
            
            </div>

            <div className="col-md-4 offset-md-2 main_bar ">
                <div className="row">
                    <div className="col-md-2 pt-2 w-50 d-flex justify-content-start">
                        <div className='d-flex flex-column'>
                            <img className='rounded-circle w-50 mx-3 border border-danger' src="https://i.ibb.co/rx1k7h1/322733152-431477945761277-2102060376022704541-n.jpg" alt="" />
                            RP SOHAG
                        </div>
                        <div className='d-flex flex-column'>
                            <img className='rounded-circle w-50 mx-3 border border-danger' src="https://i.ibb.co/rx1k7h1/322733152-431477945761277-2102060376022704541-n.jpg" alt="" />
                ...
                <div className="row mt-4">
                    <div className="col-md-12 pt-2 ">
                        <div className="row mt-1 border d-flex  ">
                            <div className="col mt-2">
                                <img className="w-100" src="https://i.ibb.co/p2Lv31y/328958020-2459561427516062-4865680250880020275-n.jpg" alt=""/>
                            </div>
                        </div>
                        <div className="row mt-1 border d-flex  ">
                            <div className="col mt-2">
